...
function yesQuestions(answer){
  //var answer =  prompt ('Can pigs fly?');

  //var answer.toUpperCase() === 'YES' || answer.toUpperCase() === 'Y');---remove
  //new code
...
/*-moved into prompt-- var question1 = prompt('Do I have siblings? Answer yes or no, y or n');
